...
function mostrarLineamiento(tipo) {
  ...
  const iconoEncabezado = document.querySelector(String.raw`#vistaLineamientos .bg-white\/20 i`);
...
function alternarDesplegable(idDesplegable) {
  ...
  const esDispositivoTactil = 'ontouchstart' in globalThis || navigator.maxTouchPoints > 0;
