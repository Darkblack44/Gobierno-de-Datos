  ...
  return `
    <div class="tarjeta-tablero">
      ...
      <div class="tarjeta-tablero-cuerpo">
        <h4 class="tarjeta-tablero-titulo">${tablero.titulo}</h4>
...
// tableroActual y panelInfoExpandido se declaran en configuracion.js (globales)
...
"${tableroActual.titulo}","${tableroActual.area}","${tableroActual.fechaActualizacion}","${tableroActual.fuente}","${tableroActual.elaboradoPor}","${tableroActual.descripcion}","${tableroActual.estado}","${tableroActual.observaciones}"`;
  ...
  enlace.setAttribute('download', `${tableroActual.titulo.replaceAll(/[^a-z0-9]/gi, '_')}.csv`);
